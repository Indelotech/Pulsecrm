      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Badge tone={customer.status === "ACTIVE" ? "green" : "blue"}>
              {humanizeEnum(customer.status)}
            </Badge>
          </div>
          <p className="mt-2 text-sm text-muted-foreground">
            {customer.companyName ?? "No company"} ·{" "}
            {formatCurrency(customer.lifetimeValue)} lifetime value
          </p>
        </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    min="0"
                    defaultValue={customer.lifetimeValue}
                  />
                </div>
              </div>
              <div className="space-y-2">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <form action={addCustomerNote.bind(null, customer.id)} className="space-y-4">
                <Textarea name="body" placeholder="Summarize the conversation..." required />
                <Button>
        ...
        <CardContent>
          {customer.notes.length ? (
            ...
            <EmptyState
              ...
              title="No notes yet"
              description="Add the first note to keep customer history organized."
            />
          )}
        </CardContent>
      </Card>
